...
Frühere Versionen (bis TLS 1.1) enthielten aufgrund von gesetzlichen Vorschriften zum Export von Kryptographie aus den USA \ciphersuites{}, die durch Nutzung kürzerer Schlüssel leichter zu brechen sein sollten (so genannte export-geschwächte \ciphersuites{}). Diese teilweise noch unterstützten Verfahren ermöglichen noch heute Angriffe auf SSL/TLS, z.B. den FREAK-Angriff in Abschnitt \ref{sec_attack_freak}.
...
\textbf{TLS 1.3} liegt momentan als Draft vor (\cite{tls13}, Version von Oktober 2015]). Die hier dargestellten Informationen stellen also lediglich den aktuellen Entwicklungsstand dar und sind daher nicht als endgültig und nur mit Bedacht zu betrachten.\\
